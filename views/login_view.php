    ...
    <section class="vh-100 container mt-5">
        <div class="container-fluid h-custom">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form name="f1" action="../controllers/login_controller.php" class="border p-3" onsubmit="validation()" method = "POST">
                    <!-- Email input -->
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2 ">
                        <button type="submit" class="btn btn-primary btn-lg col-12">Login</button>
                    </div>
                    <div class="text-center mt-3">
                        <a href="register_view.php" class="link-danger"><button type="button" class="btn btn-success">Create new account</button></a>
                    </div>
                </form>
            </div>
            </div>
