        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-6 col-lg-6 col-xl-5 offset-xl-1">
                    <form name="f1" action="insert.php" class="border p-3" onsubmit="validation()" method = "POST">
                        <!-- Email input -->
                        <div class="form-outline">
                            <label class="form-label" for="form3Example3">Your Name</label>
                            <input type="name" id="form3Example3" name="username" class="form-control form-control-lg"
                        ...
                        <div class="text-center text-lg-start pt-2 mx-auto">
                            ...
                            <p class="small fw-bold mt-2 pt-1 mb-0">Already have an account! <a href="../account/login.php"
